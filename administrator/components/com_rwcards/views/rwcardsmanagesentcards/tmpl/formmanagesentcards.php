...
<div class="col100">
	...
	<table class="adminlist">
		...
		<tfoot>
			<tr>
				<td colspan="12"><?php echo $this->rwcards['_pageNav']->getListFooter(); ?></td>
			</tr>
		</tfoot>
		<tbody>
	<?php
	...
	?>
				...
				<td align="center"><?php echo htmlentities( $row[$i]->nameTo, ENT_QUOTES, 'UTF-8' ) . "<br />" . $row[$i]->emailTo; ?></td>
				<td align="center"><?php echo htmlentities( $row[$i]->nameFrom, ENT_QUOTES, 'UTF-8' ) . "<br />" . $row[$i]->emailFrom; ?></td>
				<td><img src="../images/stories/cards/<?php echo strtolower( substr($row[$i]->picture, 0, -4) ) . $suffix . strtolower( substr($row[$i]->picture, strrpos($row[$i]->picture, ".")) ); ?>" border="0" title="<?php echo nl2br($row[$i]->description); ?>" /></td>
				<td><?php echo nl2br( htmlentities( $row[$i]->message, ENT_QUOTES, 'UTF-8' ) ); ?></td>
