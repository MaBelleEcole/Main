	...
	<thead>
		...
		<tr>
			...
			<td>
				...
				if (count($gd) > 0)
				{
					$jpg = ($gd["GD Version"] <= "2.0") ? $gd["JPEG Support"] : $gd["JPG Support"];
					...
					echo "JPG Support: "; echo ($jpg) ? "<span style='color:green'>" . JText::_( 'YES' ) : "<span style='color:red'>" . JText::_( 'NO' ); echo "</span><br \>";
