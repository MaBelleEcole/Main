...
<script language="javascript" type="text/javascript">
	function submitbutton(pressbutton)
	{
		...
		if (document.getElementById('autor').value == ""){
			alert( "<?php echo JText::_( 'ECARD_MUST_HAVE_TITLE', true ); ?>" );
		} else {
			submitform( pressbutton );
		}
	}
...
<div class="col100">
	<table class="admintable">
		...
		<tr>
			...
			<td>
		<input class="text_area" type="text" name="autor" id="autor" size="50" maxlength="250" value="<?php echo htmlentities( @$this->rwcards['rows']->autor, ENT_QUOTES, 'UTF-8' );?>" />
			</td>
		</tr>
		<tr>
			<td width="100" align="right" class="key">
			...
			<td>
		<input class="text_area" type="text" name="email" id="email" size="50" maxlength="250" value="<?php echo htmlentities( @$this->rwcards['rows']->email, ENT_QUOTES, 'UTF-8' );?>" />
			</td>
		</tr>
		<tr>
			...
			<td>
		<textarea  name="description" id="description" rows="5" cols="45" class="inputbox"><?php echo htmlentities( @$this->rwcards['rows']->description, ENT_QUOTES, 'UTF-8' );?></textarea>
			</td>
		</tr>
		<tr>
			<td width="100" align="right" class="key">
...
<div id="otherImageChosen"></div>
		...
		<tr>
			...
			<td>
				<?php  echo JHTML::_('select.radiolist', $arr, "published", @$attribs, 'value', 'text', (int) @$this->rwcards['rows']->published, @$this->rwcards['rows']->id ); ?>
			</td>
		</tr>
		</tbody>
	</table>
